...
class LabelWindow( Gtk.Window):
    def __init__( self):
        ...
        label = Gtk.Label( "This is an example of a line-wrapped label.  It "
                           "should not be taking up entire                 "
        ...
        label = Gtk.Label( "This is an example of a line-wrapped, filled label. "
                           "It should be taking "
                           "up the entire                with allocated to it.  "
                           "Here is a sentence to prove "
                           "my point. Here is another sentence. "
                           "Here comes the sun, do de do de do de do.\n"
        ...
        label.set_markup("Text can be <small>small</small>, <big>big</big>, "
                         ...
                         "title=\"Clock to find out more\">internets</a>.")
        label.set_line_wrap( True)
        vbox_left.pack_start( label, True, True, 0)
        ...
        button = Gtk.Button( label = "Click at your risk")
